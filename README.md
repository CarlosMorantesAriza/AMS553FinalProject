...
2. Generate the number of individuals per species that enter the population.
  ...
  *  Single step approach: Generate number of recruited trees per species (maybe something like $Pois(\frac{\sum_i N_i}{K})$ or $Pois(\frac{\sum_i N_i}{K} \frac{N_i}{\sum_i N_i}) = Pois(\frac{N_i}{K})$ )   
